...
_default_config = {
    ...
    'EMAIL_SUBJECT_PASSWORD_NOTICE': _('Пароль был успешно изменен.'),
...
_default_messages = {
    ...
    'CONFIRM_REGISTRATION': (
        _('Спасибо! Ссылка на подтверждение была отправлена на %(email)s.'),
        'success'),
    'EMAIL_CONFIRMED': (
        _('Спасибо! Вы подтвердили свою электронну почту.'), 'success'),
    'ALREADY_CONFIRMED': (
        _('Вы уже подтвердили свою электронную почту.'), 'info'),
    'INVALID_CONFIRMATION_TOKEN': (
        _('Invalid confirmation token.'), 'error'),
    'EMAIL_ALREADY_ASSOCIATED': (
        _('%(email)s is already associated with an account.'), 'error'),
    'PASSWORD_MISMATCH': (
        _('Паролдь не подходит.'), 'error'),
    'RETYPE_PASSWORD_MISMATCH': (
        _('Пароли не сходятся.'), 'error'),
    'INVALID_REDIRECT': (
        _('Redirections outside the domain are forbidden'), 'error'),
    'PASSWORD_RESET_REQUEST': (
        _('Письмо для изменения пароля было отправлено на почту %(email)s.'),
        'info'),
    ...
    'CONFIRMATION_REQUIRED': (
        _('Нужно подтверждение электронной почты.'), 'error'),
    'CONFIRMATION_REQUEST': (
        _('Подтверждение было отправлено на почту %(email)s.'), 'info'),
